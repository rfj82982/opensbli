...
eqns = [x0, u0, p, d, rho, rhou0, rhoE, f]
...
if not weno and not teno:
    if TVD:
        TVD_filter = TVDFilter(block, airfoil=False, passive_scalar=True)
...
OPSC(alg)
constants = ['gama', 'dt', 'niter', 'block0np0', 'Delta0block0', 'eps', 'inv_rfact0_block0', 'lambda0_TVD', 'TENO_CT','alpha','S']
