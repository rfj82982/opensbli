...
constants = ['Re', 'gama', 'Minf', 'Pr', 'dt', 'niter', 'block0np0', 'block0np1', 'Delta0block0', 'Delta1block0', 'Twall', 'mu']
values = ['2.1e6', '1.4', '0.2', '0.71', '0.000002', '500000000', '1129', '161', '37.6887/(block0np0-1)', '36.9844/(block0np1-1)', '1.0', '1.0']
