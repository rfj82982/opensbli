...
q_hdf5.add_arrays([DataObject('kappa'), DataObject('divV'), DataObject('omega_z'), DataObject('rho_SFD'), DataObject('rhou0_SFD'), DataObject('rhou1_SFD'), DataObject('rhoE_SFD')])
