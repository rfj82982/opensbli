...
ops_par_loop(opensbliblock00Kernel050, "Temporal solution advancement", opensbliblock00, 3, iteration_range_50_block0,
...
ops_halo_transfer(periodicBC_direction0_side0_51_block0);
ops_halo_transfer(periodicBC_direction0_side1_52_block0);
ops_halo_transfer(periodicBC_direction1_side0_53_block0);
ops_halo_transfer(periodicBC_direction1_side1_54_block0);
ops_halo_transfer(periodicBC_direction2_side0_55_block0);
ops_halo_transfer(periodicBC_direction2_side1_56_block0);
int iteration_range_43_block0[] = {-2, block0np0 + 3, -2, block0np1 + 3, -2, block0np2 + 3};
...
ops_par_loop(opensbliblock00Kernel044, "UserDefinedEquations evaluation", opensbliblock00, 3, iteration_range_44_block0,
ops_arg_dat(u0_B0, 1, stencil_0_22_22_22_24, "double", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_22_22_22_24, "double", OPS_READ),
ops_arg_dat(u2_B0, 1, stencil_0_22_22_22_24, "double", OPS_READ),
ops_arg_dat(kappa_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_45_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel045, "User kernel: Zero the work arrays", opensbliblock00, 3, iteration_range_45_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
int iteration_range_46_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel046, "User kernel: WENO reconstruction direction 0", opensbliblock00, 3, iteration_range_46_block0,
ops_arg_dat(a_B0, 1, stencil_0_01_00_00_5, "double", OPS_READ),
ops_arg_dat(kappa_B0, 1, stencil_0_32_00_00_13, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_12_00_00_9, "double", OPS_READ),
...
int iteration_range_47_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel047, "User kernel: WENO reconstruction direction 1", opensbliblock00, 3, iteration_range_47_block0,
ops_arg_dat(a_B0, 1, stencil_0_00_01_00_5, "double", OPS_READ),
ops_arg_dat(kappa_B0, 1, stencil_0_00_32_00_13, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_00_12_00_9, "double", OPS_READ),
...
int iteration_range_48_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1};
ops_par_loop(opensbliblock00Kernel048, "User kernel: WENO reconstruction direction 2", opensbliblock00, 3, iteration_range_48_block0,
ops_arg_dat(a_B0, 1, stencil_0_00_00_01_5, "double", OPS_READ),
ops_arg_dat(kappa_B0, 1, stencil_0_00_00_32_13, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_00_00_12_9, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel049, "User kernel: Non-linear filter application", opensbliblock00, 3, iteration_range_49_block0,
